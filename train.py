...
ghj = 8
while (ghj>0):
 for idx, bita in enumerate (train_images):
  initialization(bita)
  findel(bita, train_labels[idx])
 ghj -= 1



trai4= np.zeros(60000)
...
np.savetxt("predicted_class_label_2014EE30542.csv", trai4, delimiter = ",")
